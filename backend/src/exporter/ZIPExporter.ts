...
export class ZIPExporter {
  ...
  private generateReadme(idea: AppIdea): string {
    ...
    readme += `## Support\n\n`;
    readme += `This project was generated by Gyon. For questions or issues:\n\n`;
  ...
  private generateApiKeysGuide(idea: AppIdea): string {
    ...
    guide += `---\n\n`;
    guide += `**Generated by Gyon** | Happy coding! 🎉\n`;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <span class="badge">Generated by Gyon</span>
        </div>
        ...
        <div class="footer">
            ...
            <p>Created with <a href="https://github.com/yourusername/gyon" target="_blank">Gyon</a></p>
        </div>
    </div>
</body>
</html>`;
